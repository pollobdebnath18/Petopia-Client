...
const MyListingspage = async () => {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 my-8 pt-8 py-24">
      {/* HEADER */}
      <div className="mb-10 text-center">
        ...
        <p className="text-gray-500 mt-2 text-sm sm:text-base dark:text-white/60">
      ...
      {/* EMPTY STATE */}
      {myPets.length === 0 ? (
        <div className="flex flex-col items-center justify-center text-center py-14 sm:py-20 px-4 bg-white rounded-2xl shadow-md border dark:bg-black">
        ...
        <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 mb-10 mx-16 md:mx-12 lg:mx-0">
            <div className="bg-white shadow-md rounded-2xl p-5 sm:p-6 border text-center dark:bg-gray-800 dark:border-white/30">
              <h2 className="text-gray-500 font-medium dark:text-white/70 dark:font-bold">
                Total Listings
              </h2>

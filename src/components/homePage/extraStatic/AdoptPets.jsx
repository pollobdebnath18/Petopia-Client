    ...
    <section className="w-full py-20 bg-white dark:bg-black ">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="text-center">
          ...
          <p className="mt-4 text-gray-600 max-w-2xl mx-auto dark:text-white/60">
        ...
        <div className="mt-14 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 ">
          {/* Card 1 */}
          <div className="group bg-white border border-gray-200 rounded-2xl p-8 shadow-sm hover:shadow-xl transition duration-300 text-center dark:text-white/70 dark:border-white/30 dark:bg-gray-800">
            ...
            <p className="mt-3 text-gray-600 text-sm leading-relaxed dark:text-white/40">
          ...
          {/* Card 2 */}
          <div className="group bg-white border border-gray-200 rounded-2xl p-8 shadow-sm hover:shadow-xl transition duration-300 text-center dark:border-white/30  dark:bg-gray-800 dark:text-white/70">
          ...
          {/* Card 3 */}
          <div className="group bg-white border border-gray-200 rounded-2xl p-8 shadow-sm hover:shadow-xl transition duration-300 text-center dark:bg-gray-800 dark:text-white/70 dark:border-white/30">

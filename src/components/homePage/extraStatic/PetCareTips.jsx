    ...
    <section className="w-full py-20 bg-gray-50 dark:bg-black">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="mt-14 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {/* Card 1 */}
          <div className="group bg-white rounded-2xl p-8 shadow-sm hover:shadow-xl transition duration-300 border border-gray-100 dark:bg-gray-800 dark:text-white/70 dark:border-white/30">
